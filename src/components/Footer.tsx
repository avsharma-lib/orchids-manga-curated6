    ...
    <footer className="bg-[var(--ink)] text-[var(--paper)]">
      <div className="mx-auto max-w-7xl px-6 lg:px-12 py-16">
        ...
        <p className="text-[var(--mist)] max-w-2xl leading-relaxed text-base mb-12">
          A curated collection of premium apparel. We believe in quality over quantity,
            ...
            <ul className="space-y-4 text-sm text-[var(--mist)]">
              <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:inkai.apparel@gmail.com" className="hover:text-[var(--paper)] transition-colors">inkai.apparel@gmail.com</a>
                </li>
